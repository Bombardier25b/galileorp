...
Config.Zones = {
	...
	respray = {
		Pos   = { x = -198.68, y = -1324.24, z = 30.71 },
		Size  = {x = 3.0, y = 3.0, z = 0.2},
		Color = {r = 204, g = 204, b = 0},
		Marker= 1,
		Name  = _U('blip_name'),
...
Config.Menus = {
	...
	modTransmission = {
		...
		parent = 'upgrades',
		modType = 13,
		price = {0.95, 1.56, 3.12}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
		modType = 15,
		price = {0.95, 1.56, 2.12, 2.53}
	},
	modArmor = {
		label = _U('armor'),
		parent = 'upgrades',
